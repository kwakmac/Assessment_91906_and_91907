...
def run_game(player_id):
    ...
    #helps with scaling every object/component in my program so it can fit nicly on diferen monitor screens
    ...
    leaderboard_btn_surface = pygame.Surface(scale_obj_size(300,75))
    leaderboard_btn_surface.fill("Yellow")
    leaderboard_btn_rect = leaderboard_btn_surface.get_rect(midbottom = scale_obj_position(1690, 350))

    test_btn_surface = pygame.Surface(scale_obj_size(300,75))
    test_btn_surface.fill("Yellow")
    test_btn_rect = test_btn_surface.get_rect(midbottom = scale_obj_position(1690, 450))
    ...
    leaderboard_text_rect = leaderboard_text_surface.get_rect(midbottom = scale_obj_position(1690, 350))

    test_text_surface = font_1.render("test", False, "White")
    test_text_rect = test_text_surface.get_rect(midbottom = scale_obj_position(1690, 450))
    ...
    btn_hub_surface = pygame.Surface(scale_obj_size(1630, 350))
    btn_hub_rect = btn_hub_surface.get_rect(midbottom = scale_obj_position(960, 1020))

    diff_hub_surface = pygame.Surface(scale_obj_size(200, 282))
    diff_hub_surface.fill(GREY)
    diff_hub_rect = diff_hub_surface.get_rect(midbottom = scale_obj_position(747, 985))

    bet_hub_surface = pygame.Surface(scale_obj_size(600, 282))
    bet_hub_surface.fill(GREY)
    bet_hub_rect = bet_hub_surface.get_rect(midbottom = scale_obj_position(1205, 985))
    ...
    spin_btn_surface = pygame.Surface(scale_obj_size(180, 282))
    spin_btn_surface.fill(GREY)
    spin_btn_rect = spin_btn_surface.get_rect(midbottom = scale_obj_position(1647, 985))

    diff_increase_btn_surface = pygame.Surface(scale_obj_size(50, 50))
    diff_increase_btn_surface.fill(BLACK)
    diff_increase_btn_rect = diff_increase_btn_surface.get_rect(midbottom = scale_obj_position(747, 790))
    ...
    diff_decrease_btn_surface = pygame.Surface(scale_obj_size(50, 50))
    diff_decrease_btn_surface.fill(BLACK)
    diff_decrease_btn_rect = diff_decrease_btn_surface.get_rect(midbottom = scale_obj_position(747, 947))
    ...
    bet_increase_btn_surface = pygame.Surface(scale_obj_size(50, 50))
    bet_increase_btn_surface.fill(BLACK)
    bet_increase_btn_rect = bet_increase_btn_surface.get_rect(midbottom = scale_obj_position(1217, 826))
    ...
    bet_decrease_btn_surface = pygame.Surface(scale_obj_size(50, 50))
    bet_decrease_btn_surface.fill(BLACK)
    bet_decrease_btn_rect = bet_decrease_btn_surface.get_rect(midbottom = scale_obj_position(973, 826))

    bet_increase_amount_multi_surface = pygame.Surface(scale_obj_size(50, 50))
    bet_increase_amount_multi_surface.fill(BLACK)
    bet_increase_amount_multi_rect = bet_increase_amount_multi_surface.get_rect(midbottom = scale_obj_position(1173, 911))
    ...
    bet_decrease_amount_multi_surface = pygame.Surface(scale_obj_size(50, 50))
    bet_decrease_amount_multi_surface.fill(BLACK)
    bet_decrease_amount_multi_rect = bet_decrease_amount_multi_surface.get_rect(midbottom = scale_obj_position(1018, 911))

    crt_ans_surface = pygame.Surface(scale_obj_size(150, 145))
    crt_ans_surface.fill(GREY)
    crt_ans_rect = crt_ans_surface.get_rect(midbottom = scale_obj_position(515, 985))

    info_display_btn_surface = pygame.Surface(scale_obj_size(100, 145))
    info_display_btn_surface.fill(GREY)
    info_display_btn_rect = info_display_btn_surface.get_rect(midbottom = scale_obj_position(360, 985))

    option_display_btn_surface = pygame.Surface(scale_obj_size(100, 145))
    option_display_btn_surface.fill(GREY)
    option_display_btn_rect = option_display_btn_surface.get_rect(midbottom = scale_obj_position(229, 985))
    ...
    option_display_btn_text_rect = option_display_btn_text_surface.get_rect(midbottom = scale_obj_position(229, 985))

    crt_ans_text_surface = font_2.render(str(current_player_answered_correct), False, "White")
    crt_ans_text_rect = crt_ans_text_surface.get_rect(midbottom = scale_obj_position(515, 985))

    info_display_btn_text_surface = font_2.render("info", False, "White")
    info_display_btn_text_rect = info_display_btn_text_surface.get_rect(midbottom = scale_obj_position(360, 985))
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                ...
                #info  btn
                    if info_display_btn_text_rect.collidepoint(event.pos):
                        print("info")
                        feedback_display_text_surface = font_2.render(("info"), False, "White")
                #spin btn
