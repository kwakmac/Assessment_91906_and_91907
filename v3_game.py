...
SCREEN_WIDTH = 1920
SCREEN_HEIGHT = 1080
SCREEN_WIDTH = pygame.display.Info().current_w #gets the monitor screen size - width
SCREEN_HEIGHT = pygame.display.Info().current_h #gets the monitor screen size - height

monitor_size = (SCREEN_WIDTH, SCREEN_HEIGHT)

scaling_w = SCREEN_WIDTH/SCREEN_WIDTH
scaling_h = SCREEN_HEIGHT/SCREEN_HEIGHT
...
quit_btn_rect = quit_btn_surface.get_rect(center = (1890, 30))
...
payout_btn_rect = payout_btn_surface.get_rect(midbottom = (1620, 980))

bet_decrease_btn_surface = pygame.Surface((75,75))
bet_decrease_btn_rect = bet_decrease_btn_surface.get_rect(midbottom = (200, 860))

bet_increase_btn_surface = pygame.Surface((75,75))
bet_increase_btn_rect = bet_increase_btn_surface.get_rect(midbottom = (500, 860))

diff_decrease_btn_surface = pygame.Surface((75,75))
diff_decrease_btn_rect = diff_decrease_btn_surface.get_rect(midbottom = (700, 860))

diff_increase_btn_surface = pygame.Surface((75,75))
diff_increase_btn_rect = diff_increase_btn_surface.get_rect(midbottom = (1000, 860))

diff_dis_surface = pygame.Surface((200,75))
diff_dis_rect = diff_dis_surface.get_rect(midbottom = (350, 860))

bet_dis_surface = pygame.Surface((200,75))
bet_dis_rect = bet_dis_surface.get_rect(midbottom = (850, 860))
...
payout_text_rect = payout_text_surface.get_rect(midbottom = (1620, 980))

bet_decrease_text_surface = gameplay_btn_font.render("-", False, "White")
bet_decrease_text_rect = bet_decrease_text_surface.get_rect(midbottom = (200, 860))

bet_increase_text_surface = gameplay_btn_font.render("+", False, "White")
bet_increase_text_rect = bet_increase_text_surface.get_rect(midbottom = (500, 860))

diff_decrease_text_surface = gameplay_btn_font.render("-", False, "White")
diff_decrease_text_rect = bet_decrease_text_surface.get_rect(midbottom = (700, 860))

diff_increase_text_surface = gameplay_btn_font.render("+", False, "White")
diff_increase_text_rect = bet_increase_text_surface.get_rect(midbottom = (1000, 860))

diff_dis_text_surface = gameplay_btn_font.render("diff", False, "White")
diff_dis_text_rect = bet_decrease_text_surface.get_rect(midbottom = (350, 860))

bet_dis_text_surface = gameplay_btn_font.render("bet", False, "White")
bet_dis_text_rect = bet_increase_text_surface.get_rect(midbottom = (850, 860))
...
#drawing (displaying sprites/objects)
    ...
    #gameplay page    SCREEN_WIDTH, SCREEN_HEIGHT
    elif game_state == "gameplay":
        screen.fill(RED)
        ...
        pygame.draw.line(screen, BLUE, (SCREEN_WIDTH - 100, SCREEN_HEIGHT - 300),(SCREEN_WIDTH - 100, SCREEN_HEIGHT - 50), 4) #options - right
        pygame.draw.line(screen, BLUE, (100, SCREEN_HEIGHT - 300),(100, SCREEN_HEIGHT - 50), 4) #options - left
        pygame.draw.line(screen, BLUE, (100, SCREEN_HEIGHT - 300),(SCREEN_WIDTH - 100, SCREEN_HEIGHT - 300), 4) #options - top
        pygame.draw.line(screen, BLUE, (100, SCREEN_HEIGHT - 50),(SCREEN_WIDTH - 100, SCREEN_HEIGHT - 50), 4) #options - bottom
